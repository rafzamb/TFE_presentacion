...
<img class="animated-gif"src="animate-delitos-1.gif">
...
🔸  Se utiliza el modelo **“Croston”**, siendo un modelo especial de regresiones de conteo para series intermitentes, que toma en cuenta únicamente el histórico de la ocurrencia de delitos. En la siguiente figura, se muestra el conteo histórico de delitos de una de las esquinas de CABA.
